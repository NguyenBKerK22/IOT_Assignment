...
void printHelloWorld_task(void* pvParameters);
void printXinChao_task(void* pvParameters);
void printHihi_task(void* pvParameters);
void printHoho_task(void* pvParameters);
void printGhost(void* pvParameters);
void printNotDoing(void* pvParameters);
void printDontCare(void* pvParameters);
